...
public class RoomFirstLevelGenerator : SimpleRandomWalkGenerator
{
    ...
    {
        var roomsList = ProceduralGA.BinarySpacePartitioning(new BoundsInt((Vector3Int)startPosition, 
            new Vector3Int(levelWidth, levelHeight, 0)), minRoomWidth, minRoomHeight);
